...
class Chart {
    ...
    constructor(canvas, data) {
        this.canvas = canvas;
        this.offsetX = 0; // Initial horizontal offset
        this.scale = 1.0; // Initial zoom level
        this.isDragging = false;
        this.lastX = 0; // Last mouse x position for panning
        this.padding = 30;
        this.rightPadding = 50; // Right padding width in pixels
        this.spacePadding = 15;
        ...
        this.bars = data.flatMap((chunk) => {
            ...
            return chunk.Bars.map((bar) => (Object.assign(Object.assign({}, bar), { Time: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.addSeconds)(new Date(chunk.ChunkStart * 1000), bar.TickVolume).getTime() })));
        });
    ...
    drawBar(bar, x, width, canvasHeight) {
        // Calculate height based on scaled price differences
        const pixelPerPrice = (canvasHeight / (this.highestPrice - this.lowestPrice)) * this.scale;
        ...
        const yClose = canvasHeight - (bar.Close - this.lowestPrice) * pixelPerPrice;
        // Draw high-low line
        this.ctx.beginPath();
    ...
    drawDateLabels(canvasHeight) {
        ...
        for (let i = 0; i < this.bars.length; i += labelInterval) {
            ...
            if (x >= 0 && x <= this.canvas.width - maxLabelWidth) {
                ...
                const dateLabel = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date(bar.Time), "dd MMM HH:mm");
                this.ctx.fillText(dateLabel, x, canvasHeight + 20); // Draw label above the padding area
            }
        }
    }
    drawPriceScale(canvasWidth, canvasHeight) {
        ...
        const scaledPriceLevels = Math.max(minPriceLabels, Math.min(maxPriceLabels, Math.floor(10 / this.scale)));
        ...
        for (let i = 0; i <= scaledPriceLevels; i++) {
            ...
            const y = canvasHeight - ((price - this.lowestPrice) / priceRange) * canvasHeight;
...
class ChartManager {
    createChart(canvas, data) {
        let newChart = new _Chart__WEBPACK_IMPORTED_MODULE_0__["default"](canvas, data);
        return newChart;
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   firstDataLink: () => (/* binding */ firstDataLink),
/* harmony export */   secondDataLink: () => (/* binding */ secondDataLink)
/* harmony export */ });
// constants
const firstDataLink = 'https://beta.forextester.com/data/api/Metadata/bars/chunked?Broker=Advanced&Symbol=EURUSD&Timeframe=1&Start=57674&End=59113&UseMessagePack=false';
const secondDataLink = 'https://beta.forextester.com/data/api/Metadata/bars/chunked?Broker=Advanced&Symbol=USDJPY&Timeframe=1&Start=57674&End=59113&UseMessagePack=false';
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DataFetcher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DataFetcher */ "./src/DataFetcher.ts");
/* harmony import */ var _ChartManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ChartManager */ "./src/ChartManager.ts");
...
document.addEventListener("DOMContentLoaded", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const manager = new _ChartManager__WEBPACK_IMPORTED_MODULE_1__["default"]();
    // Function to handle fetching and displaying data for a single chart
    function setupChart(dataLink, canvas) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!canvas) {
            ...
            try {
                const fetchData = new _DataFetcher__WEBPACK_IMPORTED_MODULE_0__["default"](dataLink);
                const dataResult = yield fetchData.fetchData();
    ...
    setupChart(_constants__WEBPACK_IMPORTED_MODULE_2__.firstDataLink, canvas1);
    setupChart(_constants__WEBPACK_IMPORTED_MODULE_2__.secondDataLink, canvas2);
}));
